     ...
     return (
          <>
               <svg viewBox="0 0 359.4 140.2">
                    ...
                    <path d="M 9.2164 25.7275 C 9.6802 22.6983 18.4723 15.0104 27.8905 22.48 C 28.3561 28.9202 24.1309 37.1592 20.2585 39.6926 C 9.4392 39.86 8.7494 28.035 9.2136 25.7285 "></path>
                    <path
                    ...
                    <path
                         ...
                         stroke="black"
                    ></path>
                    <path d="M 159.6092 44.7739 C 158.4762 46.8511 148.4679 54.2157 141.1032 54.5934 C 130.5284 39.8641 157.532 30.0446 159.6092 44.7739 "></path>
                    <path d="M 175.5323 43.4326 C 174.0064 43.0202 169.6388 42.4335 164.519 42.6967 C 162.2005 33.093 180.3296 36.5014 175.5057 43.4113 "></path>
                    <path d="M 19.684 40.9 C 27.8008 35.85 47.2028 32.5729 51.7068 69.5534 C 53.8403 97.9999 49.8104 109.1415 45.5434 123.8388 C 50.4098 128.243 32.479 126.8295 30.4197 126.8686 C 27.7136 126.7488 14.5078 127.718 14.3632 110.2779 C 14.0372 89.15 12.2132 47.09 19.684 40.9 "></path>
                    <path d="M 110.4901 32.9906 C 122.4842 40.5925 140.2017 50.3302 140.2344 55.3541 C 141.9517 62.8608 143.426 70.0387 140.1824 110.9719 C 137.4748 118.1175 119.6985 122.1079 97.8651 124.7169 C 89.0073 117.6496 98.815 47.265 110.4966 32.9619 "></path>
                    <path d="M 99.0073 92.8419 C 57.8534 88.2265 38.0457 148.0342 113.4304 122.0727 C 107.8534 111.8804 107.4688 94.3804 99.0073 92.8419 "></path>
                    <path d="M 168.5155 100.9388 C 173.4123 107.4679 198.5493 98.6537 197.5699 88.2071 C 196.663 81.5372 196.2641 74.1696 187.7763 68.6199 C 175.0446 63.0702 163.9451 93.104 168.5155 100.9388 "></path>
                    <path d="M 210.1581 97.4027 C 212.5683 97.9478 219.0484 94.2578 216.583 88.7582 C 213.9754 83.9934 202.2939 84.4281 206.5968 93.7734 C 207.6053 95.7904 208.6193 96.9605 210.2946 97.404"></path>
                    ...
                    <g id="leftwing">
                         ...
                         <path
                              ...
                              stroke="black"
                         ></path>
                         <path d="M 305.593 24.956 C 304.329 25.147 304.791 23.204 305.181 23.262 C 305.663 23.349 306.002 24.875 305.593 24.956 " fill="url(#grad1)"></path>
                         <path
                    ...
                    {/* <!-- butterfly body --> */}
                    <g>
                         <path d="M 293.0437 21.9765 C 293.327 21.3611 298.3635 24.383 298.0079 25.0742 C 297.5339 25.9433 292.6358 22.6647 293.0437 21.9765 " fill="black"></path>
                         <path d="M 293.1824 22.0848 C 293.4984 21.2553 292.4516 20.7812 291.9974 21.2948 C 291.3653 22.0453 292.5701 22.9736 293.1824 22.0848 " fill="black"></path>
                         <path
                    ...
                    <g className="sleepsignholder">
                         ...
                         ></path>
                         <animateTransform attributeName="transform" begin="0s" type="scale" dur="3s" from="1" to=".5" repeatCount="indefinite" />
                    ...
                    <g className="sleepsignholder">
                         <path
                              ...
                              d="M 0.9999 0.4411 C 5 0 5 0 9.5191 0.4883 C 7 -3 3.1489 -5.1567 1 -8 C 5 -7 5 -7 9 -8 C 9.1118 -8.0304 9.1347 -8.5353 8.9977 -8.4955 C 5.0036 -7.6138 4.0046 -7.611 1.0002 -8.5035 C 0.3291 -8.732 0.3215 -8.732 0.5051 -7.9975 C 3.1697 -5.1774 5.5363 -3.3921 8.5448 -0.4003 C 9.0502 0.1893 9.0502 0.1816 8.0012 -0.0175 C 5.0187 -0.4918 4.9935 -0.4918 1 0 C 0.9483 0.0073 0.9638 0.4444 0.9999 0.441"
                         ></path>
                         <animateTransform attributeName="transform" begin="0s" type="scale" dur="2.5s" from="1" to=".5" repeatCount="indefinite" />
                         <animate attributeName="opacity" from="1" to="0" dur="2.5s" repeatCount="indefinite" />
                    </g>
                    <path id="sleeproute" d="M 212.1893 78.9173 C 211 61 204 50 192.7254 43.1727 C 186.773 39.9676 187.2308 24.247 192.4201 21.1945" fill="none"></path>
