               ...
               <section className="section bg-grey services">
                    ...
                    <div className="section-center services-center">
                         <article style={{ backgroundColor: "#f97b8b" }} className="service">
                              ...
                              <div className="underline"></div>
                              <p>Create web application with admin panel and all the latest features and customer support.</p>
                         </article>
                         ...
                         >
                              ...
                              <h4>App design</h4>
                              <div className="underline"></div>
                              <p>Develop software for your company or business so it helps you to manage your business easily.</p>
                         </article>
                         ...
                         >
                              ...
                              <h4>Freelancing</h4>
                              <div className="underline"></div>
                              <p>I am available for freelance work so if you need any of your project to be done you can contact me.</p>
                         </article>
                    </div>
               </section>
          </>
